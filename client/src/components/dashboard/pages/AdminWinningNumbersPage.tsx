...
// ✅ 1) publish numbers + compute winners + refresh overview
    const handlePublish = async () => {
        ...
        try {
            ...
            // ✅ reload overview so winners show immediately
            const payout = await adminApi.getPayoutOverview(activeGame.gameId);
            setOverview(payout);
        } catch (error) {
            console.error(error);
...
// ✅ 3) label depends on selected game
...
// ✅ 4) winners list from overview (handles weird $values too)
